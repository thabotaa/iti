...
public:
    ...
    {
        shapecolor=15; ///white
        cout<<"i'm shape cotr param-less ";
    }
    Shape(int c)
    {
        shapecolor=c;
        cout<<"i'm shape cotr 1 param ";
    }
...
public:
    ...
    Rect(int nl, int n2, int n3, int n4,int c) : topLeft(nl, n2), bottomRight(n3, n4)
    {
        shapecolor=c;
        cout << "This is the Para CTOR of Rect class" << endl;
    }
...
int main()
{
    ...
    Line L(300, 450, 400, 450,2);
    Circle c(350, 350, 200,3);
    Shape* shapearr[3];
    shapearr[0]=&R;
    shapearr[1]=&L;
    shapearr[2]=&c;
